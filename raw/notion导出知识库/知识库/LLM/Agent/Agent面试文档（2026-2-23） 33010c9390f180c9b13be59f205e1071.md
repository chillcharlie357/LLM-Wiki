...
![](Agent%E9%9D%A2%E8%AF%95%E6%96%87%E6%A1%A3%EF%BC%882026-2-23%EF%BC%89/imagesdbe8af52-2431-4284-9e51-415c3073573f-03_175_1048_1942_141.jpg)
...
- Reducer:定义状态合并策略(如 add＿messages 追加消息列表)
...
| --- | --- | --- |
| Schema 字段名 | parameters | input＿schema |
| 停止原因 | finish＿reason:＂tool＿calls＂ | stop＿reason:＂tool＿use＂ |
| 结果返回方式 | tool role 独立消息 | tool＿result 在 user 消息中 |
| 并行调用 | parallel＿tool＿calls 参数 | 默认支持 |
...
最佳实践:大多数场景用 RecursiveCharacterTextSplitter,chunk＿size $=512$ ,overlap $=50-100$ 。
...
![](Agent%E9%9D%A2%E8%AF%95%E6%96%87%E6%A1%A3%EF%BC%882026-2-23%EF%BC%89/imagesdbe8af52-2431-4284-9e51-415c3073573f-23_59_532_992_184.jpg)

![](Agent%E9%9D%A2%E8%AF%95%E6%96%87%E6%A1%A3%EF%BC%882026-2-23%EF%BC%89/imagesdbe8af52-2431-4284-9e51-415c3073573f-23_98_282_949_726.jpg)
...
| 混合场景 | asyncio+run＿in＿executor | 最佳组合 |
...
- 单步执行: 在关键节点设置断点(LangGraph 的 interrupt＿before)
...
总 Token $\approx \Sigma$(每步的 input＿tokens+output＿tokens)

其中每步 input＿tokens 包括:
