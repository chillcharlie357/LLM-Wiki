---
title: 面试官皱眉：“你这个RAG项目做了哪些优化，效果怎么样？”，我：“用向量数据库加混合检索和Rerank，效果提升明显”，面试官一直在摇头
author: 程序员Carl
source: "https://mp.weixin.qq.com/s?__biz=MzkwNjc0OTMzNg==&mid=2247489305&idx=1&sn=bd148d22ec6c2d847925787c38622d39"
site: 微信公众平台
description: 以业务目标、完整链路、选型取舍、问题诊断和指标证据为主线，说明如何回答 RAG 项目优化与效果评估类面试问题。
image: https://mmbiz.qpic.cn/mmbiz_jpg/x3KhuIa4ia2BPsrVT4aN1NbXU1LevjGpnCOGn3S06ePWtwFpphRlDI9d0Jibu5iamL7DwEJ6QsdCIQ8K554iaINO57iaAk1TvlRPoZRpuic7XaF1Q/0?wx_fmt=jpeg
clipped_at: 2026-07-27T12:25:49.461Z
strategy: http
---
...
![RAG面试问题沿项目逐层下钻，应用开发者必须守住链路、选型、排障和指标答线](https://mmbiz.qpic.cn/mmbiz_png/x3KhuIa4ia2BElztfbiapYFs7fBUMBYvOOQJyeVtaJr9pw1KPE5LwN4ibR00GDPL52fZIfHqBeB0nmBvGicSmrhKj7GoDRm3ZrygXBdiaHdYfMKY/640?wx_fmt=png&from=appmsg)

RAG面试问题沿项目逐层下钻，应用开发者必须守住链路、选型、排障和指标答线
...
4. **指标证据** ：基线和改后分别怎样；
5. **适用边界** ：什么情况下这套方案不成立。
![RAG回答沿证据轴补全结论、项目事实、方案取舍、指标证据和适用边界](https://mmbiz.qpic.cn/mmbiz_png/x3KhuIa4ia2BupPAc2ic4uM1cGRj3T360AlKMeP0CqPURqfnjibQIlr31cBLXBiaGQQu10wWicXGhmbYDmjibib6jgXjwK6q7hRea14nFRD611XT9A/640?wx_fmt=png&from=appmsg)

RAG回答沿证据轴补全结论、项目事实、方案取舍、指标证据和适用边界
...
![RAG答案错误时根据Top-K证据分流检索侧和生成侧并形成单变量优化闭环](https://mmbiz.qpic.cn/sz_mmbiz_png/x3KhuIa4ia2D0wa81xUJuKJCzHpcCIgBarzWBHqYV3Rhd3ibArBGITHVHicvlACojIgIl19Mf6EltnXPnSWnU9POAFXCYwp2EJMD7u1NXibhDgQ/640?wx_fmt=png&from=appmsg)

RAG答案错误时根据Top-K证据分流检索侧和生成侧并形成单变量优化闭环
